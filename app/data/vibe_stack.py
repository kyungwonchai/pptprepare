...
KNOWHOW: list[dict[str, Any]] = [
    {
        ...
        "body": [
            ...
            "본업(일정·품질·보안)을 먼저 잡고, 부가 작업(B)은 그 위에 얹는 생산성 층입니다. 캘린더에 본업 블록을 먼저 박고, B용 시간은 겹치지 않게 둡니다.",
            "회사(사내 레포)에서는 Cline을 중심에 두고 룰·패턴과 맞춰 구현합니다. 코드·로그는 정책 선 안에서만 다루고, 사내 정책 문서는 목적 유형 1 허브에 링크해 둡니다.",
    ...
    },
    {
        ...
        "body": [
            ...
            "집에서 만든 초안은 비밀·내부 코드 없이 블록 단위로만 옮기고, 회사(사내 레포)로 옮길 때는 정책에 맞는 경로·요약·다음 액션 위주로 옮깁니다.",
        ],
    },
    {
        "title": "시간 박스",
    ...
    },
    {
        ...
        "body": [
            ...
            "스펙을 짧게 쓰고 인공지능에는 구현·보일러플레이트를 맡깁니다. 테스트를 먼저 두고 회귀를 잡게 하고, 병합 요청(PR)은 작게 나눕니다. 문서는 목적 유형 1에서 한 줄씩만 갱신합니다.",
        ],
    },
]
